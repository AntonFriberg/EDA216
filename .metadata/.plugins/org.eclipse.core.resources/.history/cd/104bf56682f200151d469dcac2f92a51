...
/**
 * CurrentUser represents the current user that has logged on to the movie
 * booking system. It is a singleton class.
 */
public class CurrentUser {
	...
	/**
	 * Get the user id of the current user. Should only be called if a user has
	 * logged in.
	 *
